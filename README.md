...
**DESAFIO [062:](https://github.com/Jul-LionProg/python.py/blob/main/062.py) 📕⬎ ⬎ ⬎**
   |  Melhore o DESAFIO 061, perguntando para o usuaio se ele quer mostrar mais algum termos, O programa encerra quando ele disser que quer mostra o Numero
   |-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
**DESAFIO [072:](https://github.com/Jul-LionProg/python.py/blob/main/072.py) 📕⬎ ⬎ ⬎**
   * Crie um programa que tenha uma tupla totalmente preenchida com uma contagem por extenso, de zero até vinte.
     Seu programa deverá ler um número pelo teclado (entre 0 e 20) e mostrá-lo por extenso.

**DESAFIO [073:](https://github.com/Jul-LionProg/python.py/blob/main/073.py) 📕⬎ ⬎ ⬎**
...
**DESAFIO [082:](https://github.com/Jul-LionProg/python.py/blob/main/082.py) 📙 ⬎ ⬎ ⬎**
...
**DESAFIO [091:](https://github.com/Jul-LionProg/python.py/blob/main/091.py) 📙 ⬎ ⬎ ⬎**
   | Crie um programa onde 4 jogadores joguem um dado e tenham resultados aleatórios. Guarde esses resultados em um dicionário. No final, coloque esse dicionário em ordem, sabendo que o vencedor tirou o maior número no dado.
|--------------------------------------------------------------------------------------------------------------------------------------------------------|

**DESAFIO [092:](https://github.com/Jul-LionProg/python.py/blob/main/092.py) 📕📕⬎ ⬎ ⬎**
